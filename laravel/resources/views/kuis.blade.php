...
<body>
    <audio id="backsoundAudio" src="{{ asset('audios/backsound.m4a') }}" loop></audio>
    <audio id="hoverSound" src="{{ asset('audios/bubbleSFX.mp3') }}"></audio>
    <audio id="correctSound" src="{{ asset('audios/correctSFX.mp3') }}"></audio>
    <audio id="incorrectSound" src="{{ asset('audios/incorrectSFX.mp3') }}"></audio>
    ...
    <div class="something">
        ...
        <div class="heartContainer">
            <img src="{{ asset('images/fullHeart.png') }}" class="heart" id="fullHeart" alt="" />
            <img src="{{ asset('images/leftHeart.png') }}" id="leftHeart" class="heart" alt="Left Half" />
            <img src="{{ asset('images/rightHeart.png') }}" id="rightHeart" class="heart" alt="Right Half" />
        </div>
    ...
    <div class="gameOverForm" id="successForm">
        ...
        <div class="statisticContainer" id="statisticForm">
            <div class="statisticContainerChild" id="correctDisplay" style="border: 5px solid rgb(77, 255, 0)">
                <div class="label" style="background-color: rgb(77, 255, 0)">Correct</div>
                <div class="value" id="correctStat">0</div>
            </div>
            <div class="statisticContainerChild" id="incorrectDisplay" style="border: 5px solid rgb(247, 60, 60)">
                <div class="label" style="background-color: rgb(247, 60, 60)">Incorrect</div>
                <div class="value" id="incorrectStat">0</div>
            </div>
            <div class="statisticContainerChild" id="scoreDisplay" style="border: 5px solid rgb(255, 136, 0)">
                <div class="label" style="background-color: rgb(255, 136, 0)">Streak</div>
                <div class="value" id="streakStat">0</div>
            </div>
            <div class="statisticContainerChild" id="streakDisplay" style="border: 5px solid rgb(45, 147, 255)">
                <div class="label" style="background-color: rgb(45, 147, 255)">Score</div>
                <div class="value" id="scoreStat">0</div>
            </div>
        </div>
        <div class="container2" id="container2">
            <div class="tryAgainBtn" id="tryAgainBtnSuccess">Try Again</div>
            <div class="returnHomeBtn2" id="returnHomeBtnSuccess">Return Home</div>
        </div>
    </div>
    <div class="gameOverForm" id="failForm">
        <p id="gameOverMessage" style="top: 25%; left: 45%">SORRY</p>
        <p style="position: absolute; top: 40%; left: 42%; font-size: 1.5rem;">
            You Run Out Of Heart
        </p>
        <div class="container2" id="container22" style="top: 60%; left: 33.6%">
            <div class="tryAgainBtn" id="tryAgainBtnFail">Try Again</div>
            <div class="returnHomeBtn2" id="returnHomeBtnFail">Return Home</div>
        </div>
    </div>
